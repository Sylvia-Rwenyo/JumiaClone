<footer class="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 newsletter-prompt">
                ...
                <div class="input-group">
                    ...
                    <button type="button" class="btn" data-mdb-ripple-init>MALE</button>
                ...
                <div class="col-4">
                    ...
                    <div class="download-prompt-btns">
                        <button class="btn" data-mdb-ripple-init><i class="fa-brands fa-apple"></i><span>Download on <br><strong>App Store</strong></span></button>
                        <button class="btn" data-mdb-ripple-init><i class="fa-brands fa-google-play"></i><span>Get it on <br><strong>Play Store</strong></span></button>
                    </div>
                </div>
        </div>
        <div class="row">
            <div class="col-4">
                <div>
                    <h6 style="font-size: 0.8em">Need Help?</h6>
                    <ul>
        ...
        <div class="row">
            <div class="col-3">
                <h6 style="font-size: 0.8em">JOIN US ON</h6>
                <ul>
